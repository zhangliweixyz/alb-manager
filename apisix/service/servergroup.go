...
func NodeUpDown(c *gin.Context) {
	...
	for _, where := range upDownObj.Where {
		url := utils.ViperConfig.GetString(where.Clusterid + ".url")
		token := utils.ViperConfig.GetString(where.Clusterid + ".token")
		endpoints := utils.ViperConfig.GetStringSlice(where.Clusterid + ".etcd")
		username := utils.ViperConfig.GetString(where.Clusterid + ".etcduser")
		password := utils.ViperConfig.GetString(where.Clusterid + ".etcdpass")
		svc := &UpDownId{
			Url:       url,
			Token:     token,
...
func CreateServerGroup(c *gin.Context) {
	...
	serviceObj.Url = utils.ViperConfig.GetString(serviceObj.Clusterid + ".url")
	serviceObj.Token = utils.ViperConfig.GetString(serviceObj.Clusterid + ".token")
...
func DeleteServerGroup(c *gin.Context) {
	...
	deleteSvcObj.Url = utils.ViperConfig.GetString(deleteSvcObj.Clusterid + ".url")
	deleteSvcObj.Token = utils.ViperConfig.GetString(deleteSvcObj.Clusterid + ".token")
...
func GetServerGroup(c *gin.Context) {
	...
	url := utils.ViperConfig.GetString(getSvcObj.Clusterid + ".url")
	token := utils.ViperConfig.GetString(getSvcObj.Clusterid + ".token")
...
func GetServerGroupByIp(c *gin.Context) {
	...
	getSvcObj.Endpoints = utils.ViperConfig.GetStringSlice(getSvcObj.Clusterid + ".etcd")
	getSvcObj.Username = utils.ViperConfig.GetString(getSvcObj.Clusterid + ".etcduser")
	getSvcObj.Password = utils.ViperConfig.GetString(getSvcObj.Clusterid + ".etcdpass")
